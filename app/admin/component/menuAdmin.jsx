...
const menuItems = [
  {
    title: "MENU",
    items: [
      { icon: "/home.svg", name: "Home", link: "/admin" },
      { 
        icon: "/teacher.svg",
        name: "Inventory", 
        link: "/admin/",
        submenu: [
          { name: "Inventory List", link: "/admin/inventory" },
          { name: "Add Inventory", link: "/admin/inventory-add" },
          { name: "Inventory Report", link: "/admin/teacher/report" },
        ]
      },
      { icon: "/student.svg", name: "Production", link: "/admin/production" },
      { icon: "/parent.svg", name: "Supplier", link: "/admin/supplier" },
      { icon: "/schooll.svg", name: "Finance", link: "/admin/finance" },
  ...
  },
  {
    title: "OTHER",
    items: [
      { icon: "/profile2.svg", name: "Profile", link: "/admin/profile" },
      { icon: "/gears1.svg", name: "Setting", link: "/admin/setting" }
    ],
  },
];
