...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black to-amber-900 p-4">
      <div className="z-10 w-full max-w-md bg-[#0f0f11]/90 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-white/10">
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  className="bg-white/5 border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-amber-200/50"
                  required
                />
                <input
                  type="text"
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-amber-200/50"
                required
              />
        ...
        <div className="flex space-x-4">
          <button
            ...
            disabled={isLoading}
            className="flex-1 bg-white/5 border border-white/10 rounded-xl py-3 flex items-center justify-center text-white hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
